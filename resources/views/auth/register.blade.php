...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <h1 class="fs-3 card-header">{{ __('Register') }}</h1>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="mb-4 row">
                                <label for="name"
                                    class="col-md-6 col-form-label text-md-right">{{ __('Name') }}</label>
                            ...
                            <div class="mb-4 row">
                                <label for="surname"
                                    class="col-md-6 col-form-label text-md-right">{{ __('Surname') }}</label>
                            ...
                            <div class="row mb-0">
                                <div class="col-md-6 offset-md-6 d-flex gap-3">
                                    <button type="reset" class="w-50 btn btn-secondary">
                                        Reset
                                    </button>
