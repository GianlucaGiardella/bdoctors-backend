...
<body>
    <div class="h-100 doctors-bg" id="app">
        <nav class="w-100 navbar navbar-expand-md navbar-light bg-white shadow-sm position-fixed top-0"
            style="z-index: 99">
            <div class="container">
                {{-- nome sito --}}
        ...
        <main class="h-100 overflow-scroll" style="padding-top: 6rem">
            @yield('content')
        </main>
    </div>
</body>
